...
Future<List<dynamic>> fetchData(mealName, date) async {
  ...
  final response = await http.get(
      Uri.parse('http://192.168.0.103:3000/meals/$userId/$mealNameID/$date'));
...
Future<int> fetchConsumedCalories(mealName, date) async {
  ...
  final response = await http.get(Uri.parse(
      'http://192.168.0.103:3000/calories/$userId/$mealNameID/$date'));
...
Future<int> fetchTotalCalories() async {
  ...
  final response = await http
      .get(Uri.parse('http://192.168.0.103:3000/totalcalories/$userId'));
...
Future<void> deleteMeal(int mealID) async {
  final response = await http.delete(
    Uri.parse('http://192.168.0.103:3000/meal/$mealID'),
  );
